...
void State::Update(DWORD dt)
{
	...
	if (ninja->GetSpeedX() > 0 && ninja->GetPositionX() > CGame::GetInstance()->GetTiledMap()->GetWidth() - NINJA_SPRITE_WIDTH)
		ninja->SetPositionX(CGame::GetInstance()->GetTiledMap()->GetWidth() - NINJA_SPRITE_WIDTH);
